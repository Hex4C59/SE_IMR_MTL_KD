...
Evaluation script for trained VAD regression model.
...
def evaluate_model(model, dataloader, criterion, device, use_classification=True):
...
def main():
    ...
    metrics = evaluate_model(model, dataloader, criterion, device, use_classification)
    ...
    with open(results_file, "w") as f:
        ...
        if use_classification:
            f.write(f"Classification Accuracy: {metrics['classification_accuracy']:.4f}\n\n")
