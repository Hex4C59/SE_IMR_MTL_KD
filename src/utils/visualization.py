...
def plot_training_summary(
    ...
    if use_classification:
        ...
        axes[0, 0].plot(
            epochs, train_total_losses, label="Train Total Loss", color="blue"
        )
        axes[0, 0].plot(
            epochs, val_total_losses, label="Validation Total Loss", color="orange"
        )
        ...
        axes[0, 1].plot(
            epochs, train_reg_losses, label="Train Regression Loss", color="green"
        )
        axes[0, 1].plot(
            epochs, val_reg_losses, label="Validation Regression Loss", color="red"
        )
        ...
        axes[1, 0].plot(
            epochs, train_cls_losses, label="Train Classification Loss", color="purple"
        )
        axes[1, 0].plot(
            epochs,
            val_cls_losses,
        ...
        line1 = ax_ccc.plot(
            epochs, avg_ccc, label="Average CCC", color="green", linewidth=2
        )
        line2 = ax_acc.plot(
            epochs,
            cls_accuracy,
        ...
        axes[0].plot(
            epochs, train_total_losses, label="Train Regression Loss", color="blue"
        )
        axes[0].plot(
            epochs, val_total_losses, label="Validation Regression Loss", color="orange"
        )
